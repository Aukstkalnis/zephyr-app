...
#define BLUENRG_GPIO_2_SPI_MOSI (BLUENRG_MODER_SERIAL0 | BLUENRG_OTYPER_PULL_UP)
#define BLUENRG_GPIO_3_SPI_MISO (BLUENRG_MODER_SERIAL0 | BLUENRG_OTYPER_PULL_UP)
#define BLUENRG_GPIO_0_CLK_PIN  (BLUENRG_MODER_SERIAL0 | BLUENRG_OTYPER_PULL_UP)
#define BLUENRG_GPIO_6_CHIP_SEL (BLUENRG_GPIO_OUTPUT | BLUENRG_OTYPER_PULL_UP)
